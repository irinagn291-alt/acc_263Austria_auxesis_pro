...
**Design DNA — `kraken` / dark / Crypto trading. Purple-accented dark UI, data-dense dashboards.**
- Layout family: `bento` — Mixed tile sizes, tight gaps, no dead cell.
- Density: comfortable. Dark-tech: void surfaces, one glow or jewel, sparse chrome.
...
- Invariant (unit-test this): Long-press 0.6s starts; vertical drag sets 1…10 min; tap ends. Phase scale 0.55→1 inhale, hold, 1→0.55 exhale. Patterns: Calm 4-2-6, Box 4-4-4, 4-7-8.
- Empty: Long-press to begin.
- Fake that fails: A practice menu tree before you can breathe.
